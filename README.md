...
| `NACA_0021_Jacobs_1.5e6.csv` | Lift coefficient data manually digitized from Jacobs (1932) "The aerodynamic characteristics of eight very thick airfoils from tests in the variable density wind tunnel". |
| `NACA_0018_Jacobs*` | Table from Jacobs and Sherman (1937), tabulated in Miley (1982) "A catalog of low Reynolds number airfoil data for wind turbine applications". |
